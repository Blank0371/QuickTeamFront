...
|---|---|---|---|
| Supabase, Inc. | Datenbank, Anmeldung, Server-Funktionen, Datensicherung | Auftragsverarbeiter | EU (Irland); Zugriffe aus den USA möglich |
| Vercel Inc. | Hosting von Website und Web-Dashboard | Auftragsverarbeiter | weltweites Servernetz, auch USA |
| Resend, Inc. | Versand von Bestätigungscodes | Auftragsverarbeiter | USA |
| 650 Industries, Inc. (Expo) | Versand von Push-Nachrichten | Auftragsverarbeiter | USA |
