...
| Recipient | Task | Role | Place of processing |
|---|---|---|---|
| Supabase, Inc. | database, authentication, server functions, backups | processor | EU (Ireland); access from the USA possible |
| Vercel Inc. | hosting of website and web dashboard | processor | worldwide server network, including the USA |
| Resend, Inc. | sending confirmation codes | processor | USA |
| 650 Industries, Inc. (Expo) | sending push messages | processor | USA |
