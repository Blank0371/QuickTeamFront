...
ausgecheckt unter `../QuickTeamMobile`**, read-only für dieses Projekt. Das ändert, worauf
...
- **Für bestehendes Produktverhalten ist der Expo-Quellcode massgeblich** —
  ...
  kein Ersatz für den Blick in `../QuickTeamMobile/src`. Eine Paritäts- oder
...
- **Nie in `../QuickTeamMobile` schreiben.** Kein Edit, kein Write, keine
